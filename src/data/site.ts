export const site = {
  ...
  description: "BhaktiMedia creates devotional videos, AI images, reels, posters, YouTube content, social media branding and spiritual digital experiences.",
...
export interface Service {
  key: string; title: string; desc: string; icon: string; href: string;
  tags?: string[]; featured?: boolean;
}
export const services: Service[] = [
  { key: "posters", title: "Devotional Posters", icon: "palette", href: "/posters",
    desc: "Traditional festival poster templates — category wise, select karo aur generate karo." },
  { key: "temple", title: "Temple Branding", icon: "landmark", href: "/services",
    desc: "Complete identity systems for mandirs — signage, trusts, events and print collateral." },
  { key: "youtube", title: "YouTube Management", icon: "youtube", href: "/services", featured: true,
    tags: ["Channel strategy", "Aarti livestreams", "SEO & analytics"],
    desc: "End-to-end channel care: planning, editing, thumbnails, SEO and community growth." },
  { key: "ai", title: "AI Image Generation", icon: "sparkles", href: "/studio?view=image", featured: true,
    tags: ["Custom deity styles", "4K upscaling", "Poster-ready art"],
    desc: "Text se divine images — koi bhi style, koi bhi size. AI Studio mein live." },
  { key: "editing", title: "Video Editing", icon: "clapperboard", href: "/services",
    desc: "Cinematic aarti films, utsav aftermovies and devotional edits with soulful pacing." },
  { key: "reels", title: "Bhakti Reels", icon: "film", href: "/services",
    desc: "Scroll-stopping vertical devotion — hooks, transitions and trending devotional audio." },
  { key: "voice", title: "Voiceovers", icon: "mic", href: "/services",
...
export const deities = [
  { name: "Shri Datta", dev: "श्री दत्तात्रेय", quote: "त्रैलोक्यनाथ, कृपानिधान", seed: "shri-datta-temple" },
  { name: "Shri Swami Samarth", dev: "श्री स्वामी समर्थ", quote: "भय नको, स्वामी आहेत", seed: "shri-swami-samarth" },
  { name: "Shri Ganesh", dev: "श्री गणेश", quote: "विघ्नहर्ता, मंगलमूर्ती", seed: "shri-ganesh-idol" },
  { name: "Shri Hanuman", dev: "श्री हनुमान", quote: "बजरंगबली की जय", seed: "shri-hanuman-temple" },
  { name: "Shri Krishna", dev: "श्री कृष्ण", quote: "मुरलीधर, मधुर मुस्कान", seed: "shri-krishna-flute" },
  { name: "Shri Lakshmi", dev: "श्री लक्ष्मी", quote: "धन, वैभव, समृद्धि", seed: "shri-lakshmi-lotus" },
];
...
export const plans = [
  { dev: "आरती", name: "Aarti", price: 4999, featured: false,
  ...
  { dev: "उत्सव", name: "Utsav", price: 11999, featured: true,
  ...
  { dev: "महायज्ञ", name: "Mahayagya", price: 24999, featured: false,
